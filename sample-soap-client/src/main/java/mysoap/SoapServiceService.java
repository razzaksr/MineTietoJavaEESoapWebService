 ...
 * 
 */
@WebServiceClient(name = "SoapServiceService", targetNamespace = "http://mysoap/", wsdlLocation = "http://localhost:8085/credits?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPSERVICESERVICE_QNAME = new QName("http://mysoap/", "SoapServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8085/credits?wsdl");
    ...
    public SoapService getSoapServicePort() {
        return super.getPort(new QName("http://mysoap/", "SoapServicePort"), SoapService.class);
    }
    ...
    public SoapService getSoapServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://mysoap/", "SoapServicePort"), SoapService.class, features);
    }
